...
public class JpetStoreTestExo1 extends AbstractTest {
	...
	public void jPetTest() {
		...
		// Je me logue
        driver.findElement(By.xpath("//a[@href='shop/signonForm.do']")).click();
        ...
        String actualMessage = driver.findElement(By.tagName("i")).getText(); 
        String expectedMessage = "Welcome ABC!";
        assertEquals("Le message de bienvenue ne pas correctement affiché", expectedMessage, actualMessage);
